...
proc mycoordnum {frame} {
    ...
    foreach ionID $ion_index {
         ...
         set hbonds [measure hbonds $cutoff_O 30 $ion $wto]
         ...
         puts $out "$frame [$ion num] [$ion get z] [$wto num] [llength $hbonds] [$proh_m17 num] [$proh_h17 num] [$proh_m21 num] [$proh_h25 num] [$proh_k33 num] [$proh_k40 num] [$proh_k44 num] [$proall num] [$proh_other num] [$proh_1inN num]"
    }
    puts "Done."
}
...
set cutoff_O 3.64; # to be replaced by g(r) min location
set cutoff_H 4.38; # to be replaced by g(r) min location
